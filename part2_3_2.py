...
if __name__ == '__main__':
    ...
    with np.load("notMNIST.npz") as data:
        ...
        z2, flattened_w2 = hidden_layer(tf.nn.relu(z1), hidden_units, hidden_units)
        z3, flattened_w3 = hidden_layer(tf.nn.relu(z2), hidden_units, 10)

        stacked_weights = [flattened_w1, flattened_w2, flattened_w3]

        error = cross_entropy(M, weight_decay, stacked_weights, z3, targetInput)
        acc = accuracy(z3, targetInput)
